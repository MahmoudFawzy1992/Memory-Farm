...
// Restructured form fields with new 3-column layout
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-6">
          {/* This space will be filled by the block editor from parent component */}
          <div className="min-h-[400px]">
            {/* Block editor will be inserted here by parent component */}
          </div>
        </div>
